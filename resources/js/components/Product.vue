<template>
  <div>
    <div class=" w-50">
      <carousel class="carousel-slider" :per-page="1" :autoplay="true" :autoplayHoverPause="true" :mouse-drag="true" 
        :loop="true" :navigation-enabled="false" :paginationEnabled="false" :autoplayTimeOut="3000" :speed="1000">
